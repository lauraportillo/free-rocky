    ...
    <div className="containerAuthor">
      ...
      <main className="containerMainAuthor">
        <div className="author">
          <h1 className="author__title">yo</h1>

          <section className="author__description">
            <p className="author__description--p">Hola!</p>
            <p className="author__description--p">
              Mi nombre es Laura y soy <span className="bold">Front-end Developer</span> junior. Estoy desarrollando
              este Escape Room para seguir practicando y mejorando mis habilidades como programadora.
            </p>
