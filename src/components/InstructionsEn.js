  ...
  return (
    <div className="containerClue01">
      ...
      <p className="instructions__text--para">
        ...
        different cultures, this will be a piece of cake! Some indications that will help you to execute the mission
        successfully: - You can play from any device - You can play alone or with friends, that depends on you - You can
        write the keys in both uppercase and lowercase, that will not be a problem - If the password is correct, a
        message will appear on your screen and it will say "correct" and the "Next" button will be enabled for you to go
        to the next screen. - I recommend you taking paper and pencil to write notes. Although if you forget something
