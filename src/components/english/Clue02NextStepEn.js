...
const Clue02NextStepEn = (props) => {
  return (
    <section className="clue02__next--step">
      <p className="clue02__text--para1">You have solved it easily, right?</p>
      <p className="clue02__text--para2">
        Now take a good look at everything that the crossword shows to you, because it hides the
        <span className="bold"> postal code </span> of the museum's location.
      </p>
      <p className="clue02__text--para1">Find out the following code:</p>
      <p className="clue02__text--para1 bold">5 + 6 + number of W + 7 + 8 + number of A</p>
